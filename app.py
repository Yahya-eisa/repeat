...
st.set_page_config(page_title="🔍 مراجعة الاوردرات المكررة المكررة", layout="wide")
st.title("🔍 مراجعة التليفونات المكررة")
st.markdown("ارفع الملف علشان تطلع الأكواد اللي ليها نفس رقم التليفون 🔥")
